...
int main(int argc, char** argv) 
{
    ...
    ull n = Random::Range(min, max);
    ull a = Random::Range(1ULL, 1000000ULL);
    ull b = Random::Range(1ULL, 1000000ULL);
    ull c = Random::Range(1ULL, 1000000ULL);
    ...
    for(ull i = 0; i < n; ++i)
    {
        ull r = Random::Range(1, 100);
        ull f = Random::Range(1, 100);
        ull w = Random::Range(1, 100);
        std::cout << r << " " << f << " " << w << "\n";

        ull score = a*r + b*f + c*w;
