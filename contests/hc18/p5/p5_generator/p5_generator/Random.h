...
{
public:
	static void Initialize() { Initialize(static_cast<unsigned int>(time(nullptr))); }
	...
	static T Range(T min, T max)
	{
		...
		const uniform_distribution_type distribution(min, max);
		return distribution(m_RandomEngine);
	}

	static std::vector<int> UniformVector(int a, int b, int n);
